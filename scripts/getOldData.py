...
cursor.execute("CREATE TABLE public.CNH (date date,ttb float,tts float,bkpr float,deal_bas_r float,yy_efee_r float,ten_dd_efee_r float,kftc_bkpr float,kftc_deal_bas_r float);")
